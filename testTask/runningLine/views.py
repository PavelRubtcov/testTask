...
def textGenerator(requeste, text):
	...
	path_to_save = './'#путь сохранения видеофаййла
	video_path = os.path.join(path_to_save, "testText" + ".mp4")#соединяет путь с именем файла
	...
	return HttpResponse(text)#вывожу на экран текст пользователя, завершаю функцию